...
Аккумулятор заряжает предметы в инвентаре игрока. Также им можно расширить ёмкость вашей эндер-сети по нажатию с зажатой клавишей Shift из интерфейса эндер-ячейки (вся накопленная аккумулятором энергия без потерь переместится в энергобуфер активного канала). 
