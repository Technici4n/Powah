...
Энергоразрядник выкачивает FE-энергию из предметов, помещённых в специальные слоты, и хранит её во внутреннем энергобуфере для последующей передачи в другие устройства. 
