...
Энерговоронка присоединяется к любому неэнергозависимому инвентарю (наподобие сундука) и заряжает FE-энергией находящиеся в нём предметы (вроде ячеек или аккумуляторов). 
