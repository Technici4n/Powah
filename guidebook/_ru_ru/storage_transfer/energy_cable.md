...
Кабели используются для передачи FE-энергии между устройствами. 

<ItemLink id="powah:wrench" /> в режиме настройки поможет вам в изменении направления передачи энергии при нажатии ПКМ по кабелю. 
