...
Kablolar, makineler arasında güç aktarımı için kullanılır. 

Yapılandırma modu seçiliyken <ItemLink id="powah:wrench" /> kullanarak bir kabloya sağ tıklayarak aktarım modunu değiştirebilirsiniz. 
