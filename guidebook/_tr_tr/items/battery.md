...
Oyuncu envanterindeyken eşyaları şarj edin, ayrıca bir Ender Hücresi GUI'sine bir Batarya'yla Shift tıklayarak bir Ender Ağı kanalının kapasitesini yükseltmek için kullanılabilir, eğer Batarya enerji içeriyorsa, o zaman ender ağ kanalına da uygulanacaktır. 
