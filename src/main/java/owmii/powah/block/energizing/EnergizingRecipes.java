...
public class EnergizingRecipes implements IEnergizingRegistry {
    ...
    public static EnergizingRecipes all() {
        ...
        INSTANCE.addRecipe(new ItemStack(IItems.NITRO_CRYSTAL, 16), 20000000, Ingredient.fromItems(Items.NETHER_STAR), Ingredient.fromItems(Blocks.REDSTONE_BLOCK), Ingredient.fromItems(Blocks.REDSTONE_BLOCK), Ingredient.fromItems(IBlocks.BLAZING_CRYSTAL));
