...
public class Blcks {
    ...
    public static final DeferredBlock<Block> ENERGIZED_STEEL = DR.register("energized_steel_block",
            () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final DeferredBlock<Block> BLAZING_CRYSTAL = DR.register("blazing_crystal_block",
            () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final DeferredBlock<Block> NIOTIC_CRYSTAL = DR.register("niotic_crystal_block",
            () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final DeferredBlock<Block> SPIRITED_CRYSTAL = DR.register("spirited_crystal_block",
            () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final DeferredBlock<Block> NITRO_CRYSTAL = DR.register("nitro_crystal_block",
            () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final DeferredBlock<Block> URANINITE = DR.register("uraninite_block", () -> new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    ...
    public static final DeferredBlock<Block> URANINITE_ORE_POOR = DR.register("uraninite_ore_poor",
            () -> new AbstractBlock(Properties.rock(3.0f, 8.0f)));
    public static final DeferredBlock<Block> URANINITE_ORE = DR.register("uraninite_ore", () -> new AbstractBlock(Properties.rock(3.2f, 8.0f)));
    ...
    public static final DeferredBlock<Block> DRY_ICE = DR.register("dry_ice", () -> new AbstractBlock(Properties.rock(2.0f, 8.0f)));
}
