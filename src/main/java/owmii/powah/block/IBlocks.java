...
public class IBlocks {
    ...
    public static final Block CABLE_STARTER = register("energy_cable_starter", new CableBlock(Properties.rockNoSolid(1.0f, 8.0f).doesNotBlockMovement(), Tier.STARTER));
    public static final Block CABLE_BASIC = register("energy_cable_basic", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.BASIC));
    public static final Block CABLE_HARDENED = register("energy_cable_hardened", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.HARDENED));
    public static final Block CABLE_BLAZING = register("energy_cable_blazing", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.BLAZING));
    public static final Block CABLE_NIOTIC = register("energy_cable_niotic", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.NIOTIC));
    public static final Block CABLE_SPIRITED = register("energy_cable_spirited", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.SPIRITED));
    public static final Block CABLE_NITRO = register("energy_cable_nitro", new CableBlock(Properties.metalNoSolid(2.0f, 20.0f).doesNotBlockMovement(), Tier.NITRO));
    ...
    public static final Block THERMO_STARTER = register("thermo_generator_starter", new ThermoBlock(Properties.rockNoSolid(1.0f, 8.0f), Tier.STARTER));
    public static final Block THERMO_BASIC = register("thermo_generator_basic", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BASIC));
    public static final Block THERMO_HARDENED = register("thermo_generator_hardened", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.HARDENED));
    public static final Block THERMO_BLAZING = register("thermo_generator_blazing", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BLAZING));
    public static final Block THERMO_NIOTIC = register("thermo_generator_niotic", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NIOTIC));
    public static final Block THERMO_SPIRITED = register("thermo_generator_spirited", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.SPIRITED));
    public static final Block THERMO_NITRO = register("thermo_generator_nitro", new ThermoBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NITRO));

    public static final Block SOLAR_PANEL_STARTER = register("solar_panel_starter", new SolarBlock(Properties.rockNoSolid(1.0f, 8.0f), Tier.STARTER));
    public static final Block SOLAR_PANEL_BASIC = register("solar_panel_basic", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BASIC));
    public static final Block SOLAR_PANEL_HARDENED = register("solar_panel_hardened", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.HARDENED));
    public static final Block SOLAR_PANEL_BLAZING = register("solar_panel_blazing", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BLAZING));
    public static final Block SOLAR_PANEL_NIOTIC = register("solar_panel_niotic", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NIOTIC));
    public static final Block SOLAR_PANEL_SPIRITED = register("solar_panel_spirited", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.SPIRITED));
    public static final Block SOLAR_PANEL_NITRO = register("solar_panel_nitro", new SolarBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NITRO));
    ...
    //
    public static final Block PLAYER_TRANSMITTER_STARTER = register("player_transmitter_starter", new PlayerTransmitterBlock(Properties.rockNoSolid(1.0f, 8.0f), Tier.STARTER));
    public static final Block PLAYER_TRANSMITTER_BASIC = register("player_transmitter_basic", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BASIC));
    public static final Block PLAYER_TRANSMITTER_HARDENED = register("player_transmitter_hardened", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.HARDENED));
    public static final Block PLAYER_TRANSMITTER_BLAZING = register("player_transmitter_blazing", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.BLAZING));
    public static final Block PLAYER_TRANSMITTER_NIOTIC = register("player_transmitter_niotic", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NIOTIC));
    public static final Block PLAYER_TRANSMITTER_SPIRITED = register("player_transmitter_spirited", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.SPIRITED));
    public static final Block PLAYER_TRANSMITTER_NITRO = register("player_transmitter_nitro", new PlayerTransmitterBlock(Properties.metalNoSolid(2.0f, 20.0f), Tier.NITRO));
    ...
    public static final Block ENERGIZED_STEEL = register("energized_steel_block", new AbstractBlock<>(Properties.metal(2.0f, 20.0f)));
    public static final Block BLAZING_CRYSTAL = register("blazing_crystal_block", new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final Block NIOTIC_CRYSTAL = register("niotic_crystal_block", new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final Block SPIRITED_CRYSTAL = register("spirited_crystal_block", new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final Block NITRO_CRYSTAL = register("nitro_crystal_block", new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final Block URANINITE = register("uraninite_block", new AbstractBlock(Properties.metal(2.0f, 20.0f)));
    public static final Block URANINITE_ORE_POOR = register("uraninite_ore_poor", new AbstractBlock(Properties.rock(1.0f, 8.0f)));
    public static final Block URANINITE_ORE = register("uraninite_ore", new AbstractBlock(Properties.rock(1.0f, 8.0f)));
    public static final Block URANINITE_ORE_DENSE = register("uraninite_ore_dense", new AbstractBlock(Properties.rock(1.0f, 8.0f)));
    public static final Block DRY_ICE = register("dry_ice", new AbstractBlock(Properties.rock(1.0f, 8.0f)));
