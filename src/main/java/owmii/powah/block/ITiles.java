...
public class ITiles {
    ...
    public static final TileEntityType<CableTile> CABLE = register("energy_cable", CableTile::new, IBlocks.CABLE_STARTER, IBlocks.CABLE_BASIC, IBlocks.CABLE_HARDENED, IBlocks.CABLE_BLAZING, IBlocks.CABLE_NIOTIC, IBlocks.CABLE_SPIRITED, IBlocks.CABLE_NITRO);
    ...
    public static final TileEntityType<SolarTile> SOLAR_PANEL = register("solar_panel", SolarTile::new, IBlocks.SOLAR_PANEL_STARTER, IBlocks.SOLAR_PANEL_BASIC, IBlocks.SOLAR_PANEL_HARDENED, IBlocks.SOLAR_PANEL_BLAZING, IBlocks.SOLAR_PANEL_NIOTIC, IBlocks.SOLAR_PANEL_SPIRITED, IBlocks.SOLAR_PANEL_NITRO);
    ...
    public static final TileEntityType<ThermoTile> THERMO_GEN = register("thermo_gen", ThermoTile::new, IBlocks.THERMO_STARTER, IBlocks.THERMO_BASIC, IBlocks.THERMO_HARDENED, IBlocks.THERMO_BLAZING, IBlocks.THERMO_NIOTIC, IBlocks.THERMO_SPIRITED, IBlocks.THERMO_NITRO);
