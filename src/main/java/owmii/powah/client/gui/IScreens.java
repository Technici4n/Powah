package owmii.powah.client.gui;

import net.minecraft.client.gui.ScreenManager;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.api.distmarker.OnlyIn;
import owmii.powah.client.gui.container.*;
...
public class IScreens {
    public static void register() {
        ...
        ScreenManager.registerFactory(IContainers.ENDER_CELL_BASIC, EnderCellScreen::new);
        ScreenManager.registerFactory(IContainers.ENDER_CELL_HARDENED, EnderCellScreen::new);
        ScreenManager.registerFactory(IContainers.ENDER_CELL_BLAZING, EnderCellScreen::new);
        ScreenManager.registerFactory(IContainers.ENDER_CELL_NIOTIC, EnderCellScreen::new);
        ScreenManager.registerFactory(IContainers.ENDER_CELL_SPIRITED, EnderCellScreen::new);
