...
public class EnergyHopperScreen extends AbstractEnergyScreen<EnergyHopperTile, EnergyHopperContainer> {
    public EnergyHopperScreen(EnergyHopperContainer container, PlayerInventory inv, ITextComponent title) {
    ...
    protected void drawForeground(MatrixStack matrix, int mouseX, int mouseY) {
        ...
        this.field_230712_o_.func_238421_b_(matrix, s, 12, 13.0F, a);
        this.field_230712_o_.func_238421_b_(matrix, Util.numFormat(e.getMaxExtract()) + " FE/t", 12, 27.0F, a);
