...
public class PowahBook {
    ...
    public static final BookEntry CABLE = register(BookEntry.create("cables").icon(IBlocks.CABLE_BASIC))
            .add(BookPage.create().item(IBlocks.CABLE_BASIC).paragraph("cables"));
