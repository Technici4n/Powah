...
public class BookPage {
    ...
    @OnlyIn(Dist.CLIENT)
    public void render(MatrixStack matrix, BookScreen screen, int mouseX, int mouseY, float partialTicks) {
...
//                }
        ...
        for (Paragraph paragraph : this.paragraphs) {
            ...
            if (!text.isEmpty()) {
                fr.func_238418_a_(new TranslationTextComponent(text, args), 9, 10 + i, screen.w - 16, 0x38453c);
    ...
    @OnlyIn(Dist.CLIENT)
    public void postRender(MatrixStack matrix, BookScreen screen, int mouseX, int mouseY, float partialTicks) {
        Minecraft mc = Minecraft.getInstance();
