        ...
        for (int i = 0; i < 8; ++i) {
            for (int j = 0; j < 6; ++j) {
                ...
                if (index < this.entries.size()) {
                    ...
                    screen.addButton(new IconButton(screen.x + 13 + j * 29, screen.y + 13 + i * 29, 24, 24, 196, 0, 0, PowahBookScreen.GUI_TEXTURE, b -> {
                        screen.mc.displayGuiScreen(new PowahBookScreen(entry.setMain(screen.entry.getMain()), 0).setPrevScreen(screen));
