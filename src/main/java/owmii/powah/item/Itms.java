...
public class Itms {
    ...
    public static final Item BATTERY_STARTER = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.STARTER));
    public static final Item BATTERY_BASIC = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.BASIC));
    public static final Item BATTERY_HARDENED = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.HARDENED));
    public static final Item BATTERY_BLAZING = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.BLAZING));
    public static final Item BATTERY_NIOTIC = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.NIOTIC));
    public static final Item BATTERY_SPIRITED = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.SPIRITED));
    public static final Item BATTERY_NITRO = REG.register("battery", new BatteryItem(new Item.Properties().group(ItemGroups.MAIN).maxStackSize(1), Tier.NITRO));
