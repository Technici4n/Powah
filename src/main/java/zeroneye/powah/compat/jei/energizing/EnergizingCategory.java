...
import zeroneye.powah.api.recipe.energizing.EnergizingRecipe;
...
public class EnergizingCategory implements IRecipeCategory<IEnergizingRecipe> {
    ...
    public void draw(IEnergizingRecipe recipe, double mouseX, double mouseY) {
        ...
        minecraft.fontRenderer.drawString(I18n.format("info.powah.energy", recipe.getEnergy()), 2.0F, 29.0F, 0x484241);
    }
}
