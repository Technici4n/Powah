...
public class Itms {
    public static final DeferredRegister<Item> DR = DeferredRegister.create(Powah.MOD_ID, Registry.ITEM_REGISTRY);
    ...
    public static final Supplier<Item> CAPACITOR_BASIC_TINY = DR.register("capacitor_basic_tiny",
            () -> new CapacitorItem(new Item.Properties().tab(ItemGroups.MAIN)));
    ...
    public static final VarReg<Tier, Item> BATTERY = new VarReg<>(DR, "battery",
            variant -> new BatteryItem(new Item.Properties().tab(ItemGroups.MAIN).stacksTo(1), variant), Tier.getNormalVariants());
    public static final Supplier<Item> AERIAL_PEARL = DR.register("aerial_pearl",
            () -> new AerialPearlItem(new Item.Properties().tab(ItemGroups.MAIN)));
    ...
    public static final Supplier<Item> BINDING_CARD = DR.register("binding_card",
            () -> new BindingCardItem(new Item.Properties().tab(ItemGroups.MAIN).stacksTo(1), false));
    public static final Supplier<Item> BINDING_CARD_DIM = DR.register("binding_card_dim",
            () -> new BindingCardItem(new Item.Properties().tab(ItemGroups.MAIN).stacksTo(1), true));
    public static final Supplier<Item> LENS_OF_ENDER = DR.register("lens_of_ender",
            () -> new LensOfEnderItem(new Item.Properties().tab(ItemGroups.MAIN)));
    public static final Supplier<Item> PHOTOELECTRIC_PANE = DR.register("photoelectric_pane",
            () -> new PhotoelectricPaneItem(new Item.Properties().tab(ItemGroups.MAIN)));
    public static final Supplier<Item> THERMOELECTRIC_PLATE = DR.register("thermoelectric_plate",
            () -> new ItemBase(new Item.Properties().tab(ItemGroups.MAIN)));
    ...
    public static final Supplier<Item> CHARGED_SNOWBALL = DR.register("charged_snowball",
            () -> new ChargedSnowballItem(new Item.Properties().tab(ItemGroups.MAIN).stacksTo(16)));
    public static final Supplier<Item> URANINITE_RAW = DR.register("uraninite_raw",
            () -> new UraniniteItem(new Item.Properties().tab(ItemGroups.MAIN)));
