...
public class Itms {
    ...
    public static final VarReg<Tier, Item> BATTERY = new VarReg<>(DR, "battery",
            variant -> new BatteryItem(new Item.Properties().arch$tab(ItemGroups.MAIN_KEY).stacksTo(1), variant), Tier.getNormalVariants());
    ...
    public static final Supplier<Item> BINDING_CARD_DIM = DR.register("binding_card_dim",
            () -> new BindingCardItem(new Item.Properties().arch$tab(ItemGroups.MAIN_KEY).stacksTo(1), true));
    public static final Supplier<Item> LENS_OF_ENDER = DR.register("lens_of_ender",
            () -> new LensOfEnderItem(new Item.Properties().arch$tab(ItemGroups.MAIN_KEY)));
    public static final Supplier<Item> PHOTOELECTRIC_PANE = DR.register("photoelectric_pane",
            () -> new PhotoelectricPaneItem(new Item.Properties().arch$tab(ItemGroups.MAIN_KEY)));
